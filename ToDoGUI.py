...
display_pane = TK.PanedWindow(base_pane, orient=TK.VERTICAL, bd=4, relief="sunken", width=680, height=550)
...
ToDolist.column("#0", width=0, stretch=TK.NO)
ToDolist.column("ID", anchor=TK.W, width=40, minwidth=25)
ToDolist.column("ToDo Item", anchor=TK.W, width=180, minwidth=25)
ToDolist.column("Date", anchor=TK.W, width=120, minwidth=25)
ToDolist.column("Status", anchor=TK.W, width=40, minwidth=25)
ToDolist.heading("#0", text="", anchor=TK.W)
ToDolist.heading("ID", text="ID", anchor=TK.W)
ToDolist.heading("ToDo Item", text="ToDo Item", anchor=TK.W)
ToDolist.heading("Date", text="Due Date", anchor=TK.W)
ToDolist.heading("Status", text="Status", anchor=TK.W)
